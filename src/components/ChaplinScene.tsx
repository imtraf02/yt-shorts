...
export const ChaplinScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0C0A09" }}>
      ...
      >
        <Img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            filter: "brightness(0.93) contrast(1.06) saturate(1.06)",
          }}
        />
      </div>

      {/* Classic Hollywood Stage / Cinema Spotlight Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(245, 158, 11, 0.05) 0%, rgba(12, 10, 9, 0.40) 75%, rgba(5, 4, 3, 0.75) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(12, 10, 9, 0.88) 0%, rgba(12, 10, 9, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(12, 10, 9, 0.92) 0%, rgba(12, 10, 9, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
