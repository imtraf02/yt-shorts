...
import { SubtitlePhrase } from "../data/darwinSubtitles";
...
export const DarwinCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.tokens.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // Vibrant Naturalist Emerald Sunburst Pill
              wordColor = "#011A0E";
              bgStyle = {
                background:
                ...
                borderRadius: 10,
                boxShadow:
                  "0 0 25px rgba(16, 185, 129, 0.95), 0 0 10px rgba(52, 211, 153, 0.85)",
                padding: "2px 14px",
                border: "2px solid #ECFDF5",
              };
            } else if (isKeyword) {
              // Antique Gold for keyword highlights
              wordColor = "#FBBF24";
              bgStyle = {
                padding: "2px 4px",
              };
