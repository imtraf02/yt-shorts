...
export const NapoleonScene: React.FC<{
  readonly src: string;
  ...
  motion = "zoom-in",
  badgeText,
  badgeColor = "#F59E0B", // Imperial Bee Gold
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0A0D14" }}>
      ...
      >
        <Img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            filter: "brightness(0.94) contrast(1.05) saturate(1.06)",
          }}
        />
      </div>

      {/* French Imperial Navy & Antique Editorial Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(30, 58, 138, 0.08) 0%, rgba(15, 23, 42, 0.40) 75%, rgba(10, 13, 20, 0.78) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(10, 13, 20, 0.88) 0%, rgba(10, 13, 20, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(10, 13, 20, 0.92) 0%, rgba(10, 13, 20, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
