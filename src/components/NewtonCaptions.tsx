...
import { SubtitlePhrase } from "../data/newtonSubtitles";
...
export const NewtonCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.tokens.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // Radiant Sunburst Amber / Liquid Gold Active Pill
              wordColor = "#140A02";
              bgStyle = {
                background: "linear-gradient(135deg, #F59E0B 0%, #FBBF24 50%, #D97706 100%)",
                borderRadius: 10,
                boxShadow:
                  "0 0 25px rgba(245, 158, 11, 0.95), 0 0 10px rgba(251, 191, 36, 0.85)",
                padding: "2px 14px",
                border: "2px solid #FEF3C7",
              };
            } else if (isKeyword) {
              // Celestial Cyan for high-contrast scholarly emphasis
              wordColor = "#38BDF8";
              bgStyle = {
                padding: "2px 4px",
              };
