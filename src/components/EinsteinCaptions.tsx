...
import { SubtitlePhrase } from "../data/einsteinSubtitles";
...
export const EinsteinCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.tokens.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // Cosmic Lavender / Stellar Violet Sunburst Pill
              wordColor = "#0C0416";
              bgStyle = {
                background: "linear-gradient(135deg, #8B5CF6 0%, #A855F7 50%, #EC4899 100%)",
                borderRadius: 10,
                boxShadow:
                  "0 0 25px rgba(168, 85, 247, 0.95), 0 0 10px rgba(236, 72, 153, 0.85)",
                padding: "2px 14px",
                border: "2px solid #FDF4FF",
              };
            } else if (isKeyword) {
              // Stellar Amber Gold for keyword highlights
              wordColor = "#FBBF24";
              bgStyle = {
                padding: "2px 4px",
              };
