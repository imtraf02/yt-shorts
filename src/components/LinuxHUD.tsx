...
export const LinuxHUD: React.FC<{
  readonly tag?: string;
  readonly accentColor?: string;
}> = ({
  tag = "LINUS TORVALDS • LINUX",
  accentColor = "#10B981", // Terminal Emerald Green
}) => {
  ...
  return (
    ...
    >
      {/* Sleek Auto-Width Header Badge with Terminal Emerald Glow */}
      <div
        style={{
          display: "inline-flex",
          alignItems: "center",
