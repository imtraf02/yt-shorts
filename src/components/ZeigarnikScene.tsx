...
export const ZeigarnikScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#060814" }}>
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(6, 8, 20, 0.88) 0%, rgba(6, 8, 20, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(6, 8, 20, 0.92) 0%, rgba(6, 8, 20, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      {badgeText && (
        <div
          style={{
            ...
            alignItems: "center",
            gap: 10,
            boxShadow: `0 8px 24px rgba(0, 0, 0, 0.5), 0 0 20px ${badgeColor}44`,
            fontFamily,
            pointerEvents: "none",
            zIndex: 150,
          }}
