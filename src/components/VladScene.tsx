...
export const VladScene: React.FC<{
  readonly src: string;
  ...
  motion = "zoom-in",
  badgeText,
  badgeColor = "#DC2626", // Blood Crimson
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0A0B10" }}>
      ...
      {/* Gothic Wallachian Crimson & Shadow Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(220, 38, 38, 0.07) 0%, rgba(19, 9, 12, 0.40) 75%, rgba(10, 11, 16, 0.80) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(10, 11, 16, 0.90) 0%, rgba(10, 11, 16, 0.50) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(10, 11, 16, 0.94) 0%, rgba(10, 11, 16, 0.68) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      {badgeText && (
        <div
          style={{
            ...
            backgroundColor: "rgba(19, 9, 12, 0.88)",
