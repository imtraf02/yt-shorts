...
export const FigmaScene: React.FC<{
  readonly src: string;
  ...
  motion = "zoom-in",
  badgeText,
  badgeColor = "#1ABCFE", // Figma Electric Blue
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0D1117" }}>
      ...
      {/* Modern Tech Atmosphere Tint: Figma Purple & Blue soft ambient */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 30%, rgba(162, 89, 255, 0.08) 0%, rgba(26, 188, 254, 0.05) 50%, rgba(13, 17, 23, 0.75) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(13, 17, 23, 0.90) 0%, rgba(13, 17, 23, 0.50) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(13, 17, 23, 0.94) 0%, rgba(13, 17, 23, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
