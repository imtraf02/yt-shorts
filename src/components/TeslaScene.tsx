...
export const TeslaScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#04060E" }}>
      ...
      {/* Deep Cyberpunk Indigo & Electric Plasma Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(0, 240, 255, 0.05) 0%, rgba(4, 6, 14, 0.40) 75%, rgba(2, 4, 10, 0.75) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(4, 6, 14, 0.88) 0%, rgba(4, 6, 14, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(4, 6, 14, 0.92) 0%, rgba(4, 6, 14, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
