...
export const CaligulaScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0F0608" }}>
      ...
      {/* Imperial Roman Crimson & Marble Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(220, 38, 38, 0.05) 0%, rgba(15, 6, 8, 0.40) 75%, rgba(6, 2, 3, 0.75) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(15, 6, 8, 0.88) 0%, rgba(15, 6, 8, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(15, 6, 8, 0.92) 0%, rgba(15, 6, 8, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      {badgeText && (
        <div
          style={{
            ...
            backgroundColor: "rgba(18, 6, 8, 0.88)",
