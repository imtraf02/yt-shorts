...
export const QinScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0C0604" }}>
      ...
      {/* Imperial Qin Obsidian & Gold Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(245, 158, 11, 0.05) 0%, rgba(16, 8, 5, 0.40) 75%, rgba(8, 3, 2, 0.78) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(14, 6, 4, 0.88) 0%, rgba(14, 6, 4, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(14, 6, 4, 0.92) 0%, rgba(14, 6, 4, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      {badgeText && (
        <div
          style={{
            ...
            backgroundColor: "rgba(18, 9, 6, 0.88)",
