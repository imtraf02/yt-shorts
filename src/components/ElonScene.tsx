...
export const ElonScene: React.FC<{
  readonly src: string;
  ...
  motion = "zoom-in",
  badgeText,
  badgeColor = "#F97316", // SpaceX Orange / Mars Flame
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#060B14" }}>
      ...
      {/* Optional Children (e.g. Header HUD) */}
      {children}
