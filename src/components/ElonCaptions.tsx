...
import { PhraseCaption } from "../data/elonSubtitles";
...
export const ElonCaptions: React.FC<{
            ...
            return (
              <span
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(135deg, #EF4444 0%, #F97316 50%, #06B6D4 100%)",
                  color: "#060B14",
                  fontSize: 48,
                  fontWeight: 900,
                  ...
                  boxShadow:
                    "0 0 24px rgba(249, 115, 22, 0.7), 0 4px 14px rgba(0, 0, 0, 0.9)",
