...
import { PhraseCaption } from "../data/figmaSubtitles";
...
export const FigmaCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.words.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // Figma Vibrant Gradient Pill: Blue -> Purple -> Red/Orange
              wordColor = "#0F172A";
              bgStyle = {
                background:
                  "linear-gradient(135deg, #1ABCFE 0%, #A259FF 55%, #F24E1E 100%)",
                borderRadius: 12,
                boxShadow:
                  "0 0 28px rgba(162, 89, 255, 0.95), 0 0 12px rgba(26, 188, 254, 0.85)",
                padding: "2px 14px",
                border: "2px solid #E0E7FF",
              };
            } else if (isKeyword) {
              // Figma Cyan / Sky Highlight
              wordColor = "#38BDF8";
              bgStyle = {
                padding: "2px 4px",
              };
