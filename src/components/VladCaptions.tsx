...
import { PhraseItem } from "../data/vladSubtitles";
...
export const VladCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.words.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // Dragon Flame Gold to Crimson Pill
              wordColor = "#0F172A";
              bgStyle = {
                background:
                  "linear-gradient(135deg, #FDE047 0%, #F59E0B 45%, #DC2626 100%)",
                borderRadius: 10,
                boxShadow:
                  "0 0 25px rgba(220, 38, 38, 0.95), 0 0 10px rgba(245, 158, 11, 0.85)",
                padding: "2px 14px",
