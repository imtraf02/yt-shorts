...
import { SubtitlePhrase } from "../data/teslaSubtitles";
...
export const TeslaCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.tokens.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // High-Voltage Electric Cyan to Royal Blue Neon Pill
              wordColor = "#040816";
              bgStyle = {
                background: "linear-gradient(135deg, #00F0FF 0%, #3B82F6 50%, #8B5CF6 100%)",
                borderRadius: 10,
                boxShadow:
                  "0 0 25px rgba(0, 240, 255, 0.95), 0 0 10px rgba(59, 130, 246, 0.85)",
                padding: "2px 14px",
                border: "2px solid #E0F2FE",
              };
            } else if (isKeyword) {
              // Neon Electric Yellow for keyword highlights
              wordColor = "#FACC15";
              bgStyle = {
                padding: "2px 4px",
              };
