...
import { SubtitlePhrase } from "../data/chaplinSubtitles";
...
export const ChaplinCaptions: React.FC<{
      ...
      >
        ...
        >
          {activePhrase.tokens.map((token, tIdx) => {
            ...
            if (isWordActive) {
              // Radiant Cinema Gold Sunburst Pill
              wordColor = "#1C1917";
              bgStyle = {
                background:
              ...
              // Vibrant Cinema Cyan for keyword highlights
              wordColor = "#38BDF8";
              bgStyle = {
                padding: "2px 4px",
              };
