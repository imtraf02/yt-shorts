...
export const EinsteinScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#06050E" }}>
      ...
      >
        <Img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            filter: "brightness(0.92) contrast(1.07) saturate(1.08)",
          }}
        />
      </div>

      {/* Cosmic Violet & Blackboard Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(168, 85, 247, 0.05) 0%, rgba(6, 5, 14, 0.40) 75%, rgba(3, 2, 8, 0.75) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(6, 5, 14, 0.88) 0%, rgba(6, 5, 14, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(6, 5, 14, 0.92) 0%, rgba(6, 5, 14, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
