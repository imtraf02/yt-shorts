...
export const NewtonScene: React.FC<{
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0C0804" }}>
      {/* Background Illustrated Image with Scholarly Camera Motion */}
      <div
        style={{
          position: "absolute",
          inset: -40,
      ...
      {/* Warm Antique Amber & Obsidian Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 40%, rgba(245, 158, 11, 0.04) 0%, rgba(12, 8, 4, 0.35) 75%, rgba(10, 6, 2, 0.72) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(12, 8, 4, 0.88) 0%, rgba(12, 8, 4, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(12, 8, 4, 0.92) 0%, rgba(12, 8, 4, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
