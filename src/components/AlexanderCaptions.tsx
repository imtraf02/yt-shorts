...
import { PhraseCaption } from "../data/alexanderSubtitles";
...
export const AlexanderCaptions: React.FC<{
      ...
      >
        {activePhrase.words.map((w, idx) => {
          ...
          if (isActive) {
            ...
            // Glowing Imperial Gold Active Pill
            return (
              <span
                key={`${w.word}-${idx}`}
                style={{
          ...
          return (
            <span
              ...
              style={{
                ...
                textShadow:
                  "0 3px 12px rgba(2, 2, 8, 0.98), 0 0 24px rgba(0,0,0,0.95), 0 1px 3px rgba(0,0,0,0.9)",
                letterSpacing: "0.5px",
                lineHeight: 1.25,
              }}
            >
