...
export const DarwinScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#040D09" }}>
      ...
      >
        <Img
          ...
          style={{
            ...
            height: "100%",
            objectFit: "cover",
            filter: "brightness(0.93) contrast(1.06) saturate(1.08)",
          }}
        />
      </div>

      {/* Victorian Naturalist Botanical Forest Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(16, 185, 129, 0.05) 0%, rgba(4, 13, 9, 0.40) 75%, rgba(2, 8, 5, 0.75) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(3, 11, 7, 0.88) 0%, rgba(3, 11, 7, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(3, 11, 7, 0.92) 0%, rgba(3, 11, 7, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      {badgeText && (
        <div
          style={{
            ...
            backgroundColor: "rgba(4, 18, 12, 0.88)",
