...
export const GenghisScene: React.FC<{
  readonly src: string;
  ...
  return (
    <AbsoluteFill style={{ overflow: "hidden", backgroundColor: "#0A0E17" }}>
      ...
      {/* Steppe Tengri Azure & Night Atmosphere Tint */}
      <div
        style={{
          position: "absolute",
          inset: 0,
          background:
            "radial-gradient(ellipse at 50% 35%, rgba(2, 132, 199, 0.05) 0%, rgba(11, 18, 32, 0.40) 75%, rgba(6, 10, 18, 0.78) 100%)",
      ...
      <div
        style={{
          ...
          height: 380,
          background:
            "linear-gradient(180deg, rgba(10, 14, 23, 0.88) 0%, rgba(10, 14, 23, 0.48) 55%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
      ...
      <div
        style={{
          ...
          height: 520,
          background:
            "linear-gradient(0deg, rgba(10, 14, 23, 0.92) 0%, rgba(10, 14, 23, 0.65) 50%, transparent 100%)",
          pointerEvents: "none",
          zIndex: 10,
        }}
      />
