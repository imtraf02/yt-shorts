...
import { PhraseCaption } from "../data/victoriaSubtitles";
...
export const VictoriaCaptions: React.FC<{
      ...
      >
        {activePhrase.words.map((w, idx) => {
          ...
          if (isActive) {
            ...
            // Glowing Victorian Gold Active Pill
            return (
              <span
                key={`${w.word}-${idx}`}
                style={{
          ...
          return (
            <span
              ...
              style={{
                ...
                textShadow:
                  "0 3px 12px rgba(4, 2, 8, 0.98), 0 0 24px rgba(0,0,0,0.95), 0 1px 3px rgba(0,0,0,0.9)",
                letterSpacing: "0.5px",
                lineHeight: 1.25,
              }}
            >
