...
def main():
    ...
    with open('whisper_bitcoin_captions.json', 'r', encoding='utf-8') as f:
    ...
    with open('scripts/aligned_bitcoin_tokens.json', 'w', encoding='utf-8') as f:
        json.dump(result_tokens, f, ensure_ascii=False, indent=2)

    print("Saved to scripts/aligned_bitcoin_tokens.json")
