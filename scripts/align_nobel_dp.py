...
def main():
    ...
    with open('scripts/nobel_script.txt', 'r', encoding='utf-8') as f:
        script_text = f.read()

    script_words = script_text.split()
    print(f"Script words: {len(script_words)}")

    with open('whisper_nobel_captions.json', 'r', encoding='utf-8') as f:
    ...
    with open('scripts/aligned_nobel_tokens.json', 'w', encoding='utf-8') as f:
        json.dump(result_tokens, f, ensure_ascii=False, indent=2)

    print("Successfully saved to scripts/aligned_nobel_tokens.json")
