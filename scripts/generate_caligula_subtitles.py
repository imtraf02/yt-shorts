...
from align_caligula_scenes import scenes_def
...
# Calculate seamless contiguous scene frame allocations (total = 2670 frames = 89.00s @ 30 FPS)
total_video_frames = 2670
...
export const caligulaSubtitles: SubtitlePhrase[] = """ + json.dumps(phrases_output, ensure_ascii=False, indent=2) + ";\n"

with open('src/data/caligulaSubtitles.ts', 'w', encoding='utf-8') as f:
    f.write(ts_code)

print("\nSuccessfully generated src/data/caligulaSubtitles.ts")
