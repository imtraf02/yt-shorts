...
from align_chaplin_scenes import scenes_def
...
# Calculate seamless contiguous scene frame allocations (total = 2000 frames = 66.67s @ 30 FPS)
...
export const chaplinSubtitles: SubtitlePhrase[] = """ + json.dumps(phrases_output, ensure_ascii=False, indent=2) + ";\n"

with open('src/data/chaplinSubtitles.ts', 'w', encoding='utf-8') as f:
    f.write(ts_code)

print("\nSuccessfully generated src/data/chaplinSubtitles.ts")
