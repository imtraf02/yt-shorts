...
while i < len(raw_tokens):
    t = raw_tokens[i]
    text = t['text'].strip()
    # Check for 'ái' + 'xác' (Isaac) at the beginning
...
with open('scripts/newton_comparison_merged.txt', 'w', encoding='utf-8') as out:
...
print("Wrote scripts/newton_comparison_merged.txt")
