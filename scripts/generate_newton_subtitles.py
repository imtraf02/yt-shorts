...
from align_newton_scenes import scenes_def
...
export const newtonSubtitles: SubtitlePhrase[] = """ + json.dumps(phrases_output, ensure_ascii=False, indent=2) + ";\n"

with open('src/data/newtonSubtitles.ts', 'w', encoding='utf-8') as f:
    f.write(ts_code)

print("\nSuccessfully wrote src/data/newtonSubtitles.ts!")
