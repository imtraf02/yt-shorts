...
def main():
    ...
    with open('whisper_steve_jobs_captions.json', 'r', encoding='utf-8') as f:
    ...
    with open('scripts/aligned_steve_tokens.json', 'w', encoding='utf-8') as f:
        json.dump(result_tokens, f, ensure_ascii=False, indent=2)

    print("Successfully saved to scripts/aligned_steve_tokens.json")
