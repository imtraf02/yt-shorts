...
# Define the 15 scenes with perfect image matching
scene_definitions = [
    ...
    {
        "scene": 1,
        "image": "images/genghis-khan/01-genghis-khan-scene.png",
    ...
    {
        "scene": 2,
        "image": "images/genghis-khan/02-genghis-khan-scene.png",
    ...
    {
        "scene": 3,
        "image": "images/genghis-khan/03-genghis-khan-scene.png",
    ...
    {
        "scene": 4,
        "image": "images/genghis-khan/04-genghis-khan-scene.png",
    ...
    {
        "scene": 5,
        "image": "images/genghis-khan/05-genghis-khan-scene.png",
    ...
    # Scene 6: 07-genghis-khan-scene.png (Horse Archers)
    # Điều khiến quân đội của ông bất bại không chỉ là ngựa và cung tên.
    {
        "scene": 6,
        "image": "images/genghis-khan/07-genghis-khan-scene.png",
    ...
    # Scene 7: 06-genghis-khan-scene.png (Rewarding Shepherd)
    # Ông thăng chức theo năng lực chứ không theo xuất thân, nên một người chăn cừu hoàn toàn có thể trở thành tướng lĩnh.
    {
        "scene": 7,
        "image": "images/genghis-khan/06-genghis-khan-scene.png",
    ...
    # Scene 8: 08-genghis-khan-scene.png (Yam postal relay)
    # Ông lập hệ thống trạm dịch Yam để tin tức băng qua hàng nghìn cây số chỉ trong thời gian ngắn,
    {
        "scene": 8,
        "image": "images/genghis-khan/08-genghis-khan-scene.png",
    ...
    # Scene 9: 09-genghis-khan-scene.png (Yassa law & religious freedom)
    # ban hành bộ luật Yassa và cho phép các tôn giáo được tự do tín ngưỡng trong đế chế.
    {
        "scene": 9,
        "image": "images/genghis-khan/09-genghis-khan-scene.png",
    ...
    # Scene 10: 10-genghis-khan-scene.png (Advancing to city)
    # Nhưng mặt tối cũng khủng khiếp không kém. Khi các thành phố kháng cự,
    {
        "scene": 10,
        "image": "images/genghis-khan/10-genghis-khan-scene.png",
    ...
    # Scene 11: 11-genghis-khan-scene.png (City burning)
    # quân Mông Cổ san phẳng chúng, và nhiều nhà sử học ước tính hàng triệu người đã thiệt mạng trong các cuộc chinh phạt. Con số chính xác vẫn còn tranh cãi.
    {
        "scene": 11,
        "image": "images/genghis-khan/11-genghis-khan-scene.png",
    ...
    # Scene 12: 12-genghis-khan-scene.png (Aged Genghis Khan)
    # Ông qua đời năm 1227 trong chiến dịch chống Tây Hạ, nguyên nhân vẫn chưa ai chắc chắn.
    {
        "scene": 12,
        "image": "images/genghis-khan/12-genghis-khan-scene.png",
    ...
    # Scene 13: 13-genghis-khan-scene.png (Secret tomb)
    ...
    {
        "scene": 13,
        "image": "images/genghis-khan/13-genghis-khan-scene.png",
    ...
    # Scene 14: 14-genghis-khan-scene.png (DNA helix)
    ...
    {
        "scene": 14,
        "image": "images/genghis-khan/14-genghis-khan-scene.png",
    ...
    # Scene 15: 15-genghis-khan-scene.png (Split ragged boy & mighty conqueror)
    ...
    {
        "scene": 15,
        "image": "images/genghis-khan/15-genghis-khan-scene.png",
...
with open('scripts/scene_timing_refined.txt', 'w', encoding='utf-8') as out:
    for idx, s in enumerate(scene_timing_info):
        start_s = s['startMs'] / 1000
        end_s = s['endMs'] / 1000
        next_start_s = (scene_timing_info[idx+1]['startMs'] / 1000) if idx + 1 < len(scene_timing_info) else 102.56
        gap_s = next_start_s - end_s
        out.write(f"Scene {s['scene']:2d} ({s['image']}): {start_s:6.2f}s - {end_s:6.2f}s (audio end). Gap: {gap_s:.2f}s\n")
print("Wrote scripts/scene_timing_refined.txt")
