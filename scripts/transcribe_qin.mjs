...
async function main() {
  ...
  const inputPath = path.join(process.cwd(), "temp_16k_qin.wav");

  console.log("Transcribing temp_16k_qin.wav with whisper.cpp...");
