...
print(f"Total tokens after split: {len(tokens)}")
...
with open('scripts/busy_comparison_aligned.txt', 'w', encoding='utf-8') as out:
...
print("Wrote scripts/busy_comparison_aligned.txt")
