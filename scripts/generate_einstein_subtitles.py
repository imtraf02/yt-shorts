...
from align_einstein_scenes import scenes_def
...
export const einsteinSubtitles: SubtitlePhrase[] = """ + json.dumps(phrases_output, ensure_ascii=False, indent=2) + ";\n"

with open('src/data/einsteinSubtitles.ts', 'w', encoding='utf-8') as f:
    f.write(ts_code)

print("\nSuccessfully wrote src/data/einsteinSubtitles.ts!")
